...
//    private AdView mAdView;
    ...
    public void getWeatherDetails(View view) {
        ...
        if(city.equals("")){
            tvResult.setText("শহরের নাম খালি রাখা যাবে না !");
        }else{
            if(!country.equals("")){
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, tempUrl, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        output +=
                                  "\nতাপমাত্রা অনুভব  - " + df.format(feelsLike) + " °সেলসিয়াস"
                                + "\nবাতাসের গতি      - " + wind +" মি./সেকেন্ড"
                                + "\nমেঘের অবস্থা      - " + clouds + "%"
                                + "\nতাপমাত্রা             - " + df.format(temp) + " °সেলসিয়াস"
                                + "\nআর্দ্রতা                - " + humidity + "%";
